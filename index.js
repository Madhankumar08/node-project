...
//const MONGO_URL = "mongodb+srv://madhankumar821:AbiMadhan821@madhankumar08.mh4lmwb.mongodb.net";
...
app.get("/", function (request, response) {
  response.send("Hello  ok  neew World");
});
...
app.post("/movies" ,async function (request, response) {
    ...
    console.log(data);
    const result = await client.db("nodeproject").collection("movies").insertMany(data);
